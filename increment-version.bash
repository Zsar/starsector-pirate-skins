...
IFS='.' read -a version_current <<< "$(sed --regexp-extended --expression "$script_get_current" --quiet zsarPirateSkins.version)"
for i in 0 1 2; do
...
sed --regexp-extended --expression "$script_update" --in-place zsarPirateSkins.version
